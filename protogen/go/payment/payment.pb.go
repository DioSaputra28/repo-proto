...
import (
	transaction "github.com/DioSaputra28/repo-proto/protogen/go/transaction"
...
type PaymentRequest struct {
	...
	TotalAmount   int32                  `protobuf:"varint,3,opt,name=total_amount,proto3" json:"total_amount,omitempty"`
...
func (x *PaymentRequest) GetTotalAmount() int32 {
	if x != nil {
...
const file_proto_payment_payment_proto_rawDesc = "" +
	...
	"\ftotal_amount\x18\x03 \x01(\x05R\ftotal_amount\x12\x10\n" +
	...
	"\tconfirmed\x18\x02 \x01(\bR\tconfirmedB8Z6github.com/DioSaputra28/repo-proto/protogen/go/paymentb\x06proto3"
