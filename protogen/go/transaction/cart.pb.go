...
type CartItem struct {
	...
	ItemPrice     int32                  `protobuf:"varint,3,opt,name=item_price,proto3" json:"item_price,omitempty"`
...
const file_proto_transaction_cart_proto_rawDesc = "" +
	...
	"\n" +
	"item_price\x18\x03 \x01(\x05R\n" +
	"item_price\x12\x18\n" +
	"\ataxable\x18\x04 \x01(\bR\ataxable\"Q\n" +
	"\x04Cart\x12\x1c\n" +
	"\tcart_uuid\x18\x01 \x01(\tR\tcart_uuid\x12+\n" +
	"\x05items\x18\x02 \x03(\v2\x15.transaction.CartItemR\x05itemsB<Z:github.com/DioSaputra28/repo-proto/protogen/go/transactionb\x06proto3"
